...
class SessionService {
  ...
  Future<void> createSession(GameSession session) async {
    final sessionRef = FirebaseFirestore.instance.collection(CollectionNames.sessions).doc();
    session.id = sessionRef.id;
    await sessionRef.set(session.toMap());
  }

  Future<void> joinSession(String sessionId) async {
    final sessionRef = FirebaseFirestore.instance.collection(CollectionNames.sessions).doc(sessionId);
